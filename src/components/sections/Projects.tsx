...
import { FileText, MessageCircle, Cpu, Image, Layers, Map } from "lucide-react";
  ...
  const projects: Project[] = [
    {
      ...
      title: "PDF-to-MCQ Assessment Generator",
      description: "Automatically generate multiple-choice questions from uploaded PDF documents for educational assessment.",
      image: "https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?auto=format&fit=crop&w=600&q=80"
    },
    {
      icon: <MessageCircle size={36} />,
      title: "WhatsApp & Web Chatbots",
      description: "Custom AI-driven chatbots for customer service, lead generation, and automated information delivery.",
      image: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=600&q=80"
    },
    {
      icon: <Cpu size={36} />,
      title: "Data Pipelines & Competitor-Tracking",
      description: "Automated systems for gathering, processing, and analyzing competitor data for strategic insights.",
      image: "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?auto=format&fit=crop&w=600&q=80"
    },
    {
      icon: <Image size={36} />,
      title: "Image Classification Modules",
      description: "AI models for healthcare diagnostics, security monitoring, and automated inventory management.",
      image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=600&q=80"
    },
    {
      icon: <Layers size={36} />,
      title: "NLP Models for Text Analysis",
      description: "Custom natural language processing for summarization, sentiment analysis, and keyword extraction.",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=600&q=80"
    },
    {
      icon: <Map size={36} />,
      title: "Travel Itinerary Planners using LLMs",
      description: "AI-powered travel planning tools that create personalized itineraries based on user preferences.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Explore our innovative AI solutions that are helping businesses transform their operations and customer experiences.
          </p>
        </div>
